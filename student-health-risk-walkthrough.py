...
def _(train_data):
    ...
    return cat_cols, metric_fns, num_cols, ord_categories, ord_cols, ord_map
...
@app.cell
def _(balanced_accuracy, cat_cols, ord_categories, ord_cols, train_data):
...
@app.cell
def _(cat_cols, metric_fns, ord_categories, ord_cols, train_data):
    _trans = ColumnTransformer(
        transformers=[
            # Ordinal Pipeline
            ('ord', Pipeline([
    ...
    return X_1, cv_1, models_1, pp_1, y_1
...
@app.cell
def _(cat_cols, metric_fns, models_1, ord_categories, ord_cols, train_fe):
    _trans = ColumnTransformer(
        transformers=[
            # Ordinal Pipeline
            ('ord', Pipeline([
